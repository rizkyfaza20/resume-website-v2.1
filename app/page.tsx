          ...
          <div className="flex flex-col md:flex-row gap-12 items-start text-left">
            ...
            <div className="flex-1">
              ...
              <div className="text-lg leading-relaxed mb-8 max-w-2xl text-zinc-300 font-medium space-y-4">
                <p>
                  DevOps and Site Reliability Engineer with approximately three
                ...
                <p className="text-sm text-zinc-500 italic">
                  Currently expanding capabilities toward system design and
                  backend engineering following a structured T-shaped learning
                  approach.
                </p>
              </div>
            </div>
        ...
        <section id="experiences" className="py-24 border-b border-zinc-900">
          ...
          <div className="space-y-24">
            ...
            <div className="group relative">
              ...
              <div className="flex flex-col md:flex-row justify-between mb-4">
                <h3 className="text-xl font-bold text-zinc-100 uppercase tracking-tight">
                  Sensoneo j.s.a (Contract) - Remote
                </h3>
                <div className="flex items-center gap-2 md:mt-0 mt-2">
                  <span className="text-[10px] font-semibold text-zinc-500 uppercase tracking-widest bg-zinc-900/30 px-2 py-1 rounded">
                    May 2025 - Present
                  </span>
                  <span className="text-[10px] font-semibold text-zinc-500 uppercase tracking-widest bg-zinc-900/30 px-2 py-1 rounded">
                    Location: Slovakia
              ...
              <ul className="space-y-4 max-w-3xl">
                <li className="flex gap-4 items-start text-base leading-relaxed">
                  ...
                  <span>
                    Optimized monitoring and incident escalation flows,{" "}
                    <b className="text-zinc-100 underline decoration-zinc-800">
                      reducing service downtime by ~10%
                    </b>{" "}
                ...
                <li className="flex gap-4 items-start text-base leading-relaxed">
                  ...
                  <span>
                    ...
                    for Azure DevOps, improving security posture and reducing
                    overhead by ~20%.
                  </span>
                </li>
                <li className="flex gap-4 items-start text-base leading-relaxed">
                  ...
                  <span>
                    ...
                    issues, stabilizing onboarding flows.
                  </span>
                </li>
                <li className="flex gap-4 items-start text-base leading-relaxed">
                  <span className="text-zinc-600 mt-1">»</span>
                  <span>
                    Collaborated with engineering to troubleshoot complex
                    infrastructure,{" "}
                    <b className="text-zinc-100 underline decoration-zinc-800">
                      reducing recurring incidents by ~15%
                    </b>
                    .
                  </span>
                </li>
                <li className="flex gap-4 items-start text-base leading-relaxed">
                  ...
                  <span>
                    ...
                    pipelines for error prevention.
                  </span>
                </li>
                <li className="flex gap-4 items-start text-base leading-relaxed">
                  <span className="text-zinc-600 mt-1">»</span>
                  <span>
                    Refactored Terraform into{" "}
                    <b className="text-zinc-100 underline decoration-zinc-800">
                      modular, environment-separated structures
                    </b>{" "}
                ...
                <li className="flex gap-4 items-start text-base leading-relaxed">
                  ...
                  <span>
                    Authored an RFC for{" "}
                    <b className="text-zinc-100 underline decoration-zinc-800">
                      Kubernetes API Gateway adoption
                    </b>{" "}
                    to support platform standardization.
                  </span>
                </li>
                <li className="flex gap-4 items-start text-base leading-relaxed">
                  <span className="text-zinc-600 mt-1">»</span>
                  <span>
                    Provided production support and monitored{" "}
                    <b className="text-zinc-100 underline decoration-zinc-800">
            ...
            <div className="group relative">
              ...
              <div className="flex flex-col md:flex-row justify-between mb-4">
                <h3 className="text-xl font-bold text-zinc-100 uppercase tracking-tight">
                  Ordivo Teknologi Indonesia (Contract)
                </h3>
                <span className="text-[10px] font-semibold text-zinc-500 mt-2 uppercase tracking-widest bg-zinc-900/30 px-2 py-1 rounded">
                  Dec 2023 - May 2025
                </span>
              </div>
              <p className="text-xs font-semibold text-zinc-500 mb-8 italic tracking-wide uppercase border-b border-zinc-900 inline-block pb-1">
            ...
            <div className="group relative">
              ...
              <div className="flex flex-col md:flex-row justify-between mb-4">
                <h3 className="text-xl font-bold text-zinc-100 uppercase tracking-tight">
                  Cargo Community Network (Remote)
                </h3>
                <span className="text-[10px] font-semibold text-zinc-500 mt-2 uppercase tracking-widest bg-zinc-900/30 px-2 py-1 rounded">
                  May 2023 - Aug 2023
                </span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
              ...
              <ul className="space-y-12">
                <li className="group">
                  <p className="text-zinc-100 font-bold mb-4 uppercase tracking-tight text-base">
                    Helm Chart Contributor – Documenso
                  </p>
                  <a
            ...
            <div>
              ...
              <ul className="space-y-12">
                <li className="group">
                  <p className="text-zinc-100 font-bold mb-4 uppercase tracking-tight text-base">
                    Speaker at iCCom-MeetHub Bandung
                  </p>
                  <a
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            >
              ...
              <p className="text-sm text-zinc-500 mb-6 leading-relaxed">
                My main blog, where I write about DevOps, SRE, and other
                technical topics.
              </p>
            ...
            >
              ...
              <p className="text-sm text-zinc-500 mb-6 leading-relaxed">
                I also publish the writings here, but not as often as on Medium.
              </p>
              <div className="text-[10px] text-zinc-600 group-hover:text-zinc-100 uppercase font-bold tracking-widest flex items-center gap-2 border-b border-zinc-900 inline-flex pb-1 group-hover:border-zinc-500">
                <span>Read Articles</span>
                <span>→</span>
